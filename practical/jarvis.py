     ...
     while (1):
        ...
        try:
            ...
            if 'wikipedia' in queuery:
                ...
                codepath = "C:\\Users\\Ashvini Goswami\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe"
                ...
                spacek("I have been created by Ashvini.")
                ...
                music_dir = "C:\\Users\\Ashvini Goswami\\Desktop\\my"
            ...
            elif "know Ashvini" in queuery:
                spacek(
                    f"yes{sex} i know him becuase of him im able to talk to you he is a very nice person would you like to know more about mister Ashvini goswami")
                s = takecommend().lower()
                if s == "yes":
                    me1()
                else:
